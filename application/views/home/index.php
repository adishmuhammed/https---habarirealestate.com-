<div class="main-slider clearfix">
 ...
 <div class="swiper-pagination"></div>
  ...
  <li class="active"><a data-toggle="tab" href="#rent">Rent</a></li>
  <li><a data-toggle="tab" href="#sell">Sell</a></li>
  <li><a data-toggle="tab" href="#lease">Lease</a></li>

    <li><a data-toggle="tab" href="#camp">Labour Camp</a></li>
</ul>
  ...
  <!--</select>-->
    ...
    <div class="searchtab">
        <div class="col-md-9 ">
          ...
          <div class="col-md-8">    
          <!--<input type="text" class="form-control" placeholder="Location" id="inputSuccess">-->
          <select class="form-control select2bs4"   name="location4">
            <option value="" >Select</option>
            <?php
            foreach($cityList->result() as $value) 
            {
...
<div class="row">
   ...
   <div class="bl">
         ...
         <h2>Helping People to Find their Home</h2>
             <p>
Al Habari group is well experienced in real estate service and property business, though in its infancy in the group and exposed to the ever-growing Qatar’s Real estate Market,
</p>
