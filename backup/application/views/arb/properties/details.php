 ...
 <div class="innerpage item-details">
    ...
    <div class="container">
     <div class="row">
        ...
        <li><img src="<?=base_url()?>uploads/upimage/<?=$images[$i]->image_name ?>"  alt="<?=$propertyList->pro_title;?>" class="full-width"></li>
       <?php
             }
         }
         else
              ...
              <ul class="row">
                ...
                ?>
                    ...
                    <div class="item">
                        ...
                        ?>
                            <a href="<?php echo site_url("LoginController/details/".$value->pro_id);?>"><img src="<?=base_url()?>uploads/upimage/<?= $value->pro_image; ?>" alt="">
                        <?php
                        }
                        ?>
                         <?php 
